...
public class ListController {
	...
	///////////////////매핑 메서드
	@RequestMapping(value="/list/recipe_list.html", method=RequestMethod.GET)
	public ModelAndView recipeListShow(String FOCUS,String FLAG, HttpSession session){
		//log
		System.out.println("------토탈 리스트 메서드 통과-------");
		System.out.println("list_total에서 focus검사 : "+FOCUS);
		System.out.println("list_total에서 flag검사 : "+FLAG);
	...
	@RequestMapping(value="/list/recipe_selected.html", method=RequestMethod.GET)
	public ModelAndView selectedRecipeShow(String id, HttpSession session){
		...
		mav.addObject("BODY", "listRecipe_seleted.jsp");
	...
	//bang
	//검색시에 뿌려줄 list
	@RequestMapping(value="/list/recipe_search.html", method=RequestMethod.GET)
