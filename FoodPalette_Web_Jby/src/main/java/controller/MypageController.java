...
public class MypageController {
	...
	@RequestMapping(value="/mypage/mypage.html",method=RequestMethod.GET)
...
//		request.setAttribute("MAX", max);
	...
	@RequestMapping(value="/mypage/update_profile.html",method=RequestMethod.POST)
	...
	@RequestMapping(value="/mypage/go_changePwd.html",method=RequestMethod.GET)
	public ModelAndView go_changePassword(HttpSession session){
		//비밀번호 변경 페이지로 이동
		ModelAndView mav = new ModelAndView("home/homepage");
		mav.addObject("BODY","changePassword.jsp");
		mav.addObject(new ChangePwd_Mypage());
		return mav;
	}
	
	@RequestMapping(value="/mypage/changePwd.html",method=RequestMethod.POST)
	public ModelAndView changePassword(ChangePwd_Mypage change,BindingResult br,HttpSession session){
		...
		if(check_current_pwd.equals(current_pwd)&&
			...
			mav.addObject("BODY","changePassword_finish.jsp");
		}
		return mav;
	}
	
	
	@RequestMapping(value="/mypage/logout.html",method=RequestMethod.GET)
